...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'transparency_setter_dialog_base.ui'))


class TransparencySetterDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(TransparencySetterDialog, self).__init__(parent)
